# FROST Root of Trust - Original Design Notes

This file contains the original architectural design discussions.
See `README.md` for the current project documentation.
